...
<body class="p-6 pb-20">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mt-16 bg-white/40 backdrop-blur-xl rounded-[4rem] p-10 border border-white text-center">
            ...
            <a href="{{ route('blood.request.create') }}" class="bg-red-600 text-white px-10 py-4 rounded-full font-bold shadow-lg shadow-red-100 hover:bg-red-700 transition active:scale-95">
                Post a Request
            </a>
        </div>
    </div>
