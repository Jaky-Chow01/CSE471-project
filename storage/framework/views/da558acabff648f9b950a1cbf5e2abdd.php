...
<body class="min-h-screen pb-24 relative">
    ...
    <div class="max-w-7xl mx-auto px-4 mt-4">
        ...
        <div class="text-center mb-8">
            <h1 class="text-2xl sm:text-3xl font-black text-gray-800 mb-2">Diagnostic Centers</h1>
            <p class="text-gray-600 font-medium text-sm sm:text-base">Find nearby diagnostic centers with services, pricing, and contact information</p>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-8">
            ...
            <div class="xl:col-span-2 space-y-6">
                <?php $__empty_1 = true; $__currentLoopData = $centers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $center): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div onclick="showOnMap('<?php echo e($center->name); ?>', '<?php echo e($center->location); ?>')" class="bg-white/90 backdrop-blur-sm p-6 rounded-[2rem] shadow-sm border border-white hover:shadow-lg transition cursor-pointer">
                        <div class="flex justify-between items-start mb-4">
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-2">
                                    <h3 class="text-xl font-bold text-gray-900"><?php echo e($center->name); ?></h3>
                                    <?php if($center->emergency_services): ?>
                                        <span class="bg-red-100 text-red-600 text-xs font-black px-2 py-1 rounded-full uppercase animate-pulse">24/7 Emergency</span>
                                    <?php endif; ?>
                                </div>
                                <p class="text-gray-600 font-medium text-sm mb-2"><?php echo e($center->location); ?></p>
                                <?php if($center->description): ?>
                                    <p class="text-gray-500 text-sm leading-relaxed"><?php echo e($center->description); ?></p>
                                <?php endif; ?>
                            </div>
                            <div class="flex gap-2 ml-4">
                                <button onclick="event.stopPropagation(); showOnMap('<?php echo e($center->name); ?>', '<?php echo e($center->location); ?>')"
                                        class="bg-red-100 text-red-600 p-3 rounded-xl hover:bg-red-200 transition">
                                    <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
                                        <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/>
                                    </svg>
                                </button>
                                <a href="tel:<?php echo e($center->contactno); ?>"
                        ...
                        <!-- Services -->
                        <?php if($center->services && count($center->services) > 0): ?>
                            <div class="mb-4">
                                <h4 class="text-sm font-bold text-gray-700 mb-2">Services Offered:</h4>
                                <div class="flex flex-wrap">
                                    <?php $__currentLoopData = $center->services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <?php if($center->operating_hours): ?>
                            <div class="mb-4">
                                ...
                                <p class="text-sm text-gray-600"><?php echo e($center->operating_hours); ?></p>
                            </div>
                        <?php endif; ?>

                        <!-- Pricing -->
                        <?php if($center->prices && count($center->prices) > 0): ?>
                            <div class="mb-4">
                                <h4 class="text-sm font-bold text-gray-700 mb-2">Sample Pricing:</h4>
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                    <?php $__currentLoopData = array_slice($center->prices, 0, 6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service => $price): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="price-card">
                                            <div class="flex justify-between items-center">
                                                <span class="text-sm font-medium text-gray-700"><?php echo e($service); ?></span>
                                                <span class="text-sm font-bold text-red-600">৳<?php echo e($price); ?></span>
                                            </div>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                        ...
                        <div class="flex items-center justify-between pt-4 border-t border-gray-100">
                            <div class="text-sm text-gray-500">
                                <span class="font-semibold">Contact:</span> <?php echo e($center->contactno); ?>

                            </div>
                            <button onclick="getDirections('<?php echo e($center->location); ?>')"
            ...
            <!-- Map Sidebar -->
            <div class="bg-white/90 backdrop-blur-sm p-6 rounded-[2rem] shadow-sm border border-white h-fit xl:sticky xl:top-6">
    ...
    <script>
        let map;
        let markers = [];
        let allCenters = <?php echo json_encode($centers, 15, 512) ?>;
...
<?php /**PATH C:\xampp\htdocs\bloodConnect\resources\views/diagnostic-centers.blade.php ENDPATH**/ ?>