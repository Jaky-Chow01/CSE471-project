                ...
                <form method="POST" action="<?php echo e(route('register.post')); ?>" class="space-y-5">
                    ...
                    <div id="donor-fields" style="display:none;" class="space-y-4 border-t border-red-100 pt-4">
                        ...
                        <div>
                            ...
                            <input type="hidden" name="location" id="location-hidden" value="<?php echo e(old('location')); ?>">
                            <input type="hidden" name="latitude" id="latitude" value="<?php echo e(old('latitude', '23.8103')); ?>">
                            <input type="hidden" name="longitude" id="longitude" value="<?php echo e(old('longitude', '90.4125')); ?>">
                            <p class="text-[10px] text-gray-400 mt-1 font-semibold" id="location-display">
                                ...
                                <span id="location-text"><?php echo e(old('location', 'Drag the pin or search to set your location')); ?></span>
                            </p>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\bloodConnect\resources\views/auth/register.blade.php ENDPATH**/ ?>