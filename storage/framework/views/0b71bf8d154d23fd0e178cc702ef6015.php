...
<body class="p-4 sm:p-6 pb-20">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="mt-10 sm:mt-16 bg-white/40 backdrop-blur-xl rounded-[3rem] sm:rounded-[4rem] p-6 sm:p-10 border border-white text-center">
            ...
            <a href="<?php echo e(route('blood.request.create')); ?>" class="inline-block bg-red-600 text-white px-8 sm:px-10 py-4 rounded-full font-bold shadow-lg shadow-red-100 hover:bg-red-700 transition active:scale-95">
                Post a Request
            </a>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\bloodConnect\resources\views/blood-types.blade.php ENDPATH**/ ?>