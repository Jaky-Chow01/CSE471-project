...
<body class="p-6 pb-20">
    <div class="max-w-6xl mx-auto">
        <div class="flex items-center justify-between mb-12">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center text-gray-600 font-bold hover:text-red-600 transition group">
            ...
            <div class="text-right">
                <h1 class="text-3xl font-black text-gray-900 tracking-tight">Blood Group Insights</h1>
        ...
        <div class="bg-white/80 backdrop-blur-md p-8 rounded-[3rem] border border-white shadow-lg mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                <a href="<?php echo e(route('blood.banks')); ?>" class="bg-gradient-to-r from-red-500 to-red-600 text-white p-6 rounded-[2rem] hover:from-red-600 hover:to-red-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                ...
                <a href="<?php echo e(route('diagnostic.centers')); ?>" class="bg-gradient-to-r from-blue-500 to-blue-600 text-white p-6 rounded-[2rem] hover:from-blue-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
                    <div class="text-center">
                        <div class="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mx-auto mb-4">
                            <svg width="32" height="32" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <?php $__currentLoopData = $bloodData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="bg-white/80 backdrop-blur-md p-8 rounded-[3rem] border border-white shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col">
                ...
                <p class="text-sm font-bold text-gray-800 mb-2 leading-tight"><?php echo e($data['desc']); ?></p>
                <p class="text-xs text-gray-500 mb-6 italic">"<?php echo e($data['fact']); ?>"</p>

                <div class="mt-auto space-y-4">
                    <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                        <p class="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-1">Donor To</p>
                        <p class="text-sm font-extrabold text-red-600"><?php echo e($data['give']); ?></p>
                    </div>
                    
                    <div class="bg-gray-50 p-4 rounded-2xl border border-gray-100">
                        <p class="text-[10px] font-black uppercase text-gray-400 tracking-widest mb-1">Recipient From</p>
                        <p class="text-sm font-extrabold text-gray-700"><?php echo e($data['receive']); ?></p>
                    </div>
                </div>
            </div>
        ...
        <div class="mt-16 bg-white/40 backdrop-blur-xl rounded-[4rem] p-10 border border-white text-center">
            <h3 class="text-xl font-black text-gray-800 mb-2">Ready to save a life?</h3>
            <p class="text-gray-500 text-sm mb-8 max-w-md mx-auto font-medium">Knowing your type is the first step. The second step is taking action when someone is in need.</p>
            <a href="<?php echo e(route('blood.request.create')); ?>" class="bg-red-600 text-white px-10 py-4 rounded-full font-bold shadow-lg shadow-red-100 hover:bg-red-700 transition active:scale-95">
                Post a Request
            </a>
        </div>
    </div>
