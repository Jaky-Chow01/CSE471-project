...
<body class="min-h-screen pb-24 relative">
    ...
    <nav class="px-4 sm:px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div class="hidden md:flex items-center gap-1">
            <a href="<?php echo e(route('home')); ?>" class="px-4 py-2 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Home</a>
            <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Dashboard</a>
            <a href="<?php echo e(route('admin.nid')); ?>" class="px-4 py-2 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Verify NID</a>
            <a href="<?php echo e(route('login')); ?>" class="ml-2 px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition shadow-md shadow-red-200">Track Donation</a>
        </div>
        <!-- Mobile hamburger -->
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 z-50 md:hidden" onclick="if(event.target===this)toggleMobileMenu()">
        ...
        <div class="absolute top-0 right-0 w-72 h-full bg-white shadow-2xl flex flex-col">
            ...
            <div class="flex flex-col gap-1 p-4 flex-1">
                <a href="<?php echo e(route('home')); ?>" class="px-4 py-3 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Home</a>
                <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-3 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Dashboard</a>
                <a href="<?php echo e(route('admin.nid')); ?>" class="px-4 py-3 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Verify NID</a>
                <a href="<?php echo e(route('login')); ?>" class="px-4 py-3 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition text-center mt-2">Track Donation</a>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 mt-4">
        ...
        <div class="mt-6 bg-white/70 backdrop-blur-md p-5 rounded-[2.5rem] border border-white shadow-sm flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a href="<?php echo e(route('login')); ?>" class="bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3 rounded-2xl text-sm transition shadow-lg shadow-red-200 flex-shrink-0">Track Donation →</a>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\bloodConnect\resources\views/find-donors.blade.php ENDPATH**/ ?>