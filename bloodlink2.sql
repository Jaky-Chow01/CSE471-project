-- ============================================================
--  BloodLink2 — Database Schema & Seed Data (Fixed)
...
CREATE TABLE IF NOT EXISTS donors (
  ...
  INDEX idx_availability (availability_today),
  INDEX idx_blood_avail (blood_group, availability_today),
...
CREATE TABLE IF NOT EXISTS donor_care (
  ...
  UNIQUE INDEX idx_donor_id (donor_id),
