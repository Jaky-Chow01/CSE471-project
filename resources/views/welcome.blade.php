...
<body class="min-h-screen pb-24 relative">
    ...
    <nav class="px-4 sm:px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
        ...
        <div class="hidden md:flex items-center gap-1">
            <a href="{{ route('find.donors') }}" class="px-4 py-2 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Find Donors</a>
            <a href="{{ route('leaderboard') }}" class="px-4 py-2 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Leaderboard</a>
            @auth
                @if(auth()->user()->isAdmin())
                    <a href="{{ route('admin.dashboard') }}" class="ml-2 px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition shadow-md shadow-red-200">Admin Panel</a>
                @elseif(auth()->user()->isDonor())
                    <a href="{{ route('donor.dashboard') }}" class="ml-2 px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition shadow-md shadow-red-200">My Panel</a>
                @else
                    <a href="{{ route('requester.dashboard') }}" class="ml-2 px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition shadow-md shadow-red-200">My Panel</a>
                @endif
            @else
                <a href="{{ route('login') }}" class="px-4 py-2 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Login</a>
                <a href="{{ route('register') }}" class="ml-2 px-4 py-2 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition shadow-md shadow-red-200">Register</a>
            @endauth
        </div>
        <!-- Mobile hamburger -->
    ...
    <div id="mobile-menu" class="hidden fixed inset-0 z-50 md:hidden" onclick="if(event.target===this)toggleMobileMenu()">
        ...
        <div class="absolute top-0 right-0 w-72 h-full bg-white shadow-2xl flex flex-col">
            ...
            <div class="flex flex-col gap-1 p-4 flex-1">
                <a href="{{ route('find.donors') }}" class="px-4 py-3 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Find Donors</a>
                <a href="{{ route('leaderboard') }}" class="px-4 py-3 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Leaderboard</a>
                <div class="h-px bg-gray-100 my-2"></div>
                @auth
                    @if(auth()->user()->isAdmin())
                        <a href="{{ route('admin.dashboard') }}" class="px-4 py-3 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition text-center">Admin Panel</a>
                    @elseif(auth()->user()->isDonor())
                        <a href="{{ route('donor.dashboard') }}" class="px-4 py-3 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition text-center">My Panel</a>
                    @else
                        <a href="{{ route('requester.dashboard') }}" class="px-4 py-3 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition text-center">My Panel</a>
                    @endif
                @else
                    <a href="{{ route('login') }}" class="px-4 py-3 text-sm font-bold text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-2xl transition">Login</a>
                    <a href="{{ route('register') }}" class="px-4 py-3 text-sm font-bold text-white bg-red-600 hover:bg-red-700 rounded-2xl transition text-center">Register</a>
                @endauth
            </div>
        </div>
    </div>
    ...
    <div class="max-w-5xl mx-auto px-3 sm:px-4 grid grid-cols-2 sm:grid-cols-3 gap-3 mt-2">
        <a href="{{ route('blood.types') }}" class="bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white flex items-center gap-3 hover:bg-white/90 transition shadow-sm">
        ...
        <a href="{{ route('blood.banks') }}" class="bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white flex items-center gap-3 hover:bg-white/90 transition shadow-sm">
            <div class="bg-red-100 p-3 rounded-2xl text-red-600 flex-shrink-0">
        ...
        <a href="{{ route('diagnostic.centers') }}" class="bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white flex items-center gap-3 hover:bg-white/90 transition shadow-sm">
            <div class="bg-red-100 p-3 rounded-2xl text-red-600 flex-shrink-0">
        ...
        <a href="{{ route('find.donors') }}" class="bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white flex items-center gap-3 hover:bg-white/90 transition shadow-sm">
        ...
        @auth
        <a href="{{ auth()->user()->isDonor() ? route('donor.dashboard') : (auth()->user()->isRequester() ? route('requester.dashboard') : route('admin.dashboard')) }}"
        ...
        @else
        <a href="{{ route('login') }}" class="bg-white/60 backdrop-blur-md p-4 rounded-3xl border border-white flex items-center gap-3 hover:bg-white/90 transition shadow-sm">
            <div class="bg-emerald-100 p-3 rounded-2xl text-emerald-600 flex-shrink-0">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 14.5v-9l6 4.5-6 4.5z"/></svg>
            </div>
            <div>
                    ...
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                        <div class="space-y-1 min-w-0">
                            <div class="flex items-center gap-2 flex-wrap">
                                <span class="text-lg sm:text-xl font-extrabold text-gray-900">{{ $request->bloodgroup }} Needed</span>
